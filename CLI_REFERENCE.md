...
🔬 Aignostics Python SDK v0.2.44 - built with love in Berlin 🐻
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1749500198650.745]
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1749500198650.8447]
* `--help`: Show this message and exit.
