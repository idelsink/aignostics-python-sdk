...
🔬 Aignostics Python SDK v0.2.80 - built with love in Berlin 🐻
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1751106970373.824]
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1751106970373.921]
* `--help`: Show this message and exit.
