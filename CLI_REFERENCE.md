...
🔬 Aignostics Python SDK v0.2.70 - built with love in Berlin 🐻
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1750874071859.114]
...
* `--upload-prefix TEXT`: Prefix for the upload destination. If not given will be set to current milliseconds.  [default: 1750874071859.204]
* `--help`: Show this message and exit.
